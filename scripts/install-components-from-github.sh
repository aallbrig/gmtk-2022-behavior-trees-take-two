...
unity_project_root="${SCRIPT_DIR}/../unity/gmtk-2022-behavior-trees-take-two"
# data struct = dir name | github URL | branch | source sub folder | destination folder
target_repos=("NavMeshComponents|https://github.com/Unity-Technologies/NavMeshComponents.git|2020.2|Assets/NavMeshComponents|${unity_project_root}/Assets/NavMeshComponents")
